...
class PlayState extends MusicBeatState
{
			...
			case 'room': //TaeYai Stage
				{
					...
					switch (SONG.song.toLowerCase())
					{
						...
						roombg = new FlxSprite(-600, -200).loadGraphic(Paths.image('BG0', 'taeyai'));
						roombg.antialiasing = true;
						roombg.scrollFactor.set(0.9, 0.9);
						roombg.active = false;
						add(roombg);

						hologramintro.frames = Paths.getSparrowAtlas('intro1', 'taeyai');
	...
	function intro(){
		...
		hologramintro.animation.play("idle");

		new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				remove(hologramintro);
			});
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
...

			{
				case 0:
					...
					hologramintro.animation.stop();
					hologramintro.active = false;
					
					FlxTween.tween(hologramintro, {alpha: 0}, Conductor.crochet / 1000, {ease: FlxEase.cubeInOut});
				case 1:
